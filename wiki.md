...
- **Instructions:** You can find the instructions on how to **compile**, **test** and **run** the project [here](README.md).
...
All the links to the issues were removed because the repository with them is private.
...
- #323 Popular Products Recommendation to New Users
...
- #517 More Relevant Recommendations need to be more prominent
 ...
 All of these were fully completed, but we also had to refine the board during the sprint, adding new feature issues (#606, #612, #615, #630, #631, #632, #633, #634 and #638), new task issues (#609, #610 and #611), and new bug issues (#607, #616, #618, #646 and #656).
...
The changelog is available in the main repository, [here](CHANGELOG.md).

### Sprint Retrospectives

The sprint retrospectives are available in [this page](sprintRetrospective.md).
